...
public class JdbcStopDao implements StopDao {
	...
	private static final String SELECT_STOP_BY_ID = "select id, name, lat, lon from stop where id=?";
	...
	public Stop getStopById(final int stopId) {
		return template.queryForObject(SELECT_STOP_BY_ID,
				new Object[] { stopId }, STOP_ROW_MAPPER);
	}
